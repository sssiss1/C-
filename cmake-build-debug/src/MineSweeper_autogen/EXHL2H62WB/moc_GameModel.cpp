...
void GameModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->gameOver((*reinterpret_cast< std::add_pointer_t<bool>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (GameModel::*)()>(_a, &GameModel::modelChanged, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (GameModel::*)(bool )>(_a, &GameModel::gameOver, 1))
            return;
    }
}
...
// SIGNAL 0
void GameModel::modelChanged()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void GameModel::gameOver(bool _t1)
{
